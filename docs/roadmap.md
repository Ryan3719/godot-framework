...
Status: implemented for Godot 4.4-compatible desktop behavior in the current development branch. Linux and macOS release exports are validated in CI; Windows and exported mobile validation plus bandwidth/resume policy remain release-hardening work.
...
Status: implemented for Godot 4.4-compatible desktop behavior in the current development branch. Linux and macOS release exports are validated in CI; Windows, exported Web/mobile validation, and application-protocol integration remain release-hardening work.
...
- Deterministic Godot Asset Library-compatible package with checksum, clean-project installation, and Linux/macOS release-export execution tests

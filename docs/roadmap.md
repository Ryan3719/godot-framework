...
Status: implemented for Godot 4.4-compatible desktop behavior in the current development branch. Linux release exports are validated in CI; Windows/macOS and exported mobile validation plus bandwidth/resume policy remain release-hardening work.
...
Status: implemented for Godot 4.4-compatible desktop behavior in the current development branch. Linux release exports are validated in CI; Windows/macOS, exported Web/mobile validation, and application-protocol integration remain release-hardening work.
...
- Deterministic Godot Asset Library-compatible package with checksum, clean-project installation, and Linux release-export execution tests
